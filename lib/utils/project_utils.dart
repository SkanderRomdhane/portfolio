class ProjectUtils {
  static const List<String> banners = [
    "assets/projects/furdtk.png",
    "assets/projects/immo.png",
  ...
  static const List<String> icons = [
    "assets/projects/logofurdtk.png",
    "assets/projects/logoxcite.png",
  ...
  static const List<String> description = [
    "Get the convenience of fruits & vegetables coming directly to your home within a short span of time and you can pick some of your best products imported from different countries and get it delivered to your doorstep being fresh and good quality",
    "This app is a free and holistic solution for digital real estate transfers. Discover the X-CITE Immo apartment discount app now with full offline functionality on all your mobile devices.",
  ...
  static const List<String> links = [
    "https://apps.apple.com/cm/app/furdtk-fruits-vegetables/id1453004209?platform=iphone",
    "https://play.google.com/store/apps/details?id=glocal.xcite.flutter&hl=fr&gl=US",
